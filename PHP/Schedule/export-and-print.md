...
<?php
    ...
    echo $schedule->width('100%')->height('525px')->currentDate(new DateTime('2017/6/5'))->contextMenuSettings($contextData)->menuItemClick("onMenuItemClick")->appointmentSettings($appointment)->render();
?>
...
<?php
    ...
    echo $button ->text('Export')->width('70px')->height('30px')->click('onClick')->render();
?>
...
<?php
    ...
    $button =  new EJ\Button('large');
    echo $button ->text('Export')->width('70px')->height('30px')->click('onExportClick')->render();
?>
...
In the `exportToExcel` method, we can pass three arguments as follows:
...
In the above export method, the appointments are mandatory to be passed as an first argument. In addition, we can also pass the specific filename (on which the exported file should be saved in the machine) and excel version as optional parameters, to export the file on specified filename and version.
...
<?php
    ...
    $button =  new EJ\Button('large');
    echo $button ->text('Print')->width('70px')->height('30px')->click('onClick')->render();
?>
...
<?php
    ...
    $schedule = new EJ\Schedule('defaultSchedule');
    echo $schedule->width('100%')->height('525px')->currentDate(new DateTime('2017/6/5'))->appointmentClick('onAppointmentClick')->appointmentSettings($appointment)->render();
?>
...
<?php
    ...
    $appointment = new EJ\Schedule\AppointmentSetting();
    $appointment->id('Id')->subject('subject')->startTime('startTime')->endTime('endTime')->allDay('allDay')->recurrence('recurrence')->recurrenceRule('recurrenceRule');

    $schedule = new EJ\Schedule('defaultSchedule');
    echo $schedule->width('100%')->height('525px')->currentDate(new DateTime('2017/6/5'))->appointmentSettings($appointment)->render();

    $button =  new EJ\Button('large');
    echo $button ->text('Import')->width('70px')->height('30px')->click('ScheduleImport')->render();
?>
