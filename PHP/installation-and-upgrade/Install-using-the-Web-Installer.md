---
layout: post
title: Installation process for Syncfusion Essential Studio PHP products
description: This section provides information regarding the Syncfusion PHP Online installer and steps for installing it
platform: php
...
You can refer to the [**Download**](https://help.syncfusion.com/php/installation-and-upgrade/download) section to learn how to get the PHP trial or licensed installer.
...
The steps below show how to install Essential Studio PHP Web Installer.

1.  Open the Syncfusion Essential Studio PHP Web Installer file from downloaded location by double-clicking it. The Installer Wizard automatically opens and extracts the package.

    ![Installer Extraction Wizard](WebInstaller/Step-by-Step-Installation_img1.png)

    
    N> The installer wizard extracts the syncfusionessentialphpwebinstaller_{version}.exe dialog, which displays the package's unzip operation.
    
2. 	The Syncfusion PHP Web Installer's welcome wizard will be displayed. Click the Next button.
...
Syncfusion PHP installer can be uninstalled in two ways.

   * Uninstall the PHP using the Syncfusion PHP web installer
   * Uninstall the PHP from Windows Control Panel

Follow either one of the option below to uninstall Syncfusion Essential Studio PHP installer.
  
**Option 1: Uninstall the PHP using the Syncfusion PHP web installer**
...
Open the Syncfusion Essential Studio PHP Online Installer file from downloaded location by double-clicking it. The Installer Wizard automatically opens and extracts the package

![Installer Extraction Wizard uninstall](WebInstaller/Step-by-Step-Installation_img1.png)
	
The Syncfusion PHP Web Installer's welcome wizard will be displayed. Click the Next button
	
![Welcome wizard uninstall](WebInstaller/Step-by-Step-Installation_img2.png)
	
	
**Option 2: Uninstall the PHP from Windows Control Panel**  
	
You can uninstall all the installed products by selecting the **Syncfusion Essential Studio {version}** entry (element 1 in the below screenshot) from the Windows control panel, or you can uninstall PHP alone by selecting the **Syncfusion Essential Studio for PHP {version}** entry (element 2 in the below screenshot) from the Windows control panel.

![Control Panel](WebInstaller/Step-by-Step-Installation_img22.png)
	
N> If the **Syncfusion Essential Studio for PHP {version}** entry is selected from the Windows control panel, the Syncfusion Essential Studio PHP alone will be removed and the below default MSI uninstallation window will be displayed.	
